...
class Core_Response
{
    ...
    public static function statusCode($code, $text = null)
    {
        ...
        $text     = (null === $text) ? self::$_statusTexts[$code] : $text;
     ...
     */
    public static function setRawHeader($rawHeader, $replace = true, $code = null)
    {
     ...
     * @param int $seconds
     */
    public static function maxAge($seconds = 1800)
    {
